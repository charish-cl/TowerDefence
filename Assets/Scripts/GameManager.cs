...
public class GameManager : MonoBehaviour
{
    ...
    [HideInInspector]
    public bool FinalRoundFinished; //最后一波！
    [Header("信息提示")]
    ...
    /// <summary>
    /// Will make the arrow collide only with enemies! 将使箭只与敌人碰撞!
    /// </summary>
    ...
    /// <summary>
    /// Handler for the enemy killed event 处理敌人死亡事件
    /// </summary>
    ...
    /// <summary>
    /// Show GUI stuff with the deprecated way 显示信息
    /// Long live Unity 4.6!
    /// </summary>
    void OnGUI()
    {
